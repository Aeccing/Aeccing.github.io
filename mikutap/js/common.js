...
(aidn.init = {
  ...
  (aidn.util = {
    ...
    getCookie: function (e) {
      ...
      return (
        0 <= e &&
          (-1 == (n = i.indexOf(";", (e = e + n.length))) && (n = i.length),
    ...
    needExpandArea: function (e) {
      ...
      return (
        (t =
          (t = 0 <= n.indexOf("iPhone") || 0 <= n.indexOf("iPod")) &&
          0 <= n.indexOf("Version/") &&
      ...
      aidn.window._isTwitteriOS &&
        ...
        aidn.window._isTwitteriOS
          ? (setTimeout(aidn.window._resizeFix, 100),
            setTimeout(aidn.window._resizeFix, 300))
  ...
  (aidn.string = {
    breakStr: function (e, t, n) {
      ...
      if (!n) return o;
      for (var g = [], d = 0, l = o.length; d < l; d++) g[d] = o[d].join("");
      return g;
    },
...
function __addRelease(e, t, n, i, a, o, r, d) {
  if (
    ...
    for (
      ...
      m && (0 < m.indexOf(l) && (c = !0), 0 < m.indexOf(s) && (u = !0));
    }
    (c && u) ||
      ((v = '<link href="https://fonts.googleapis.com/css2?family='),
      c || (v += l),
      c || u || (v += "&family="),
      u || (v += s),
    ...
    (i = "bottom"),
      (i =
        ...
        (i = 1 == r ? "top" : i) +
        ": -2px; z-index: 100000; left: 50%; transform: translateX(-50%); width:100%; max-width: 480px; color: #000; background:rgb(255, 255, 255); text-align:left; cursor:pointer; letter-spacing: .4rem; line-height: 1; border: solid 1px rgba(0, 0, 0, 0.2); transition: all .12s;"),
      (i =
        '<div id="rel_open' +
        p +
        '" style="' +
        (i +=
          "font-family:Poppins,'Noto Sans JP','YuGothic', 'Hiragino Kaku Gothic Pro', 'Yu Gothic', 'MS PGothic', sans-serif;") +
        '">');
    (i +=
      '<img src="' +
      e +
      ...
      (i +=
        '<p style="display:inline-block; vertical-align:middle; letter-spacing:0.1rem; line-height:1.5; font-weight:500;">'),
      (i +=
        '<span style="font-size:calc(0.5rem + 0.5vh); color: #f39;" class="blink">' +
        a +
        "</span><br>"),
      ...
      (i +=
        '<svg style="width: calc(24px + 2vmin); transition: fill .12s;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z"/></svg>'),
      (i += "</p>"),
      (i += "</div>"),
      //   $("body").append(i),
      (i = "<style>\n.blink{\n"),
      ...
      (i +=
        "#rel_open" +
        p +
        ":hover { background: rgba(240, 240, 240) !important; } \n"),
  ...
  "undefined" == typeof jQuery
    ...
    : ((e = window.__s) &&
      ...
      $(function () {
        ...
        8 <= e &&
          ...
          document.addEventListener("visibilitychange", function (e) {
            "visible" == document.visibilityState &&
              location.href != localStorage.getItem(_) &&
              (location.href = localStorage.getItem(_));
          }));
        for (
          var t = document.querySelectorAll(".lazy_css"), n = 0, o = t.length;
          n < o;
          n++
        )
          t[n].rel = "stylesheet";
        ...
        if (
          ((0 < a.indexOf("MSIE") || 0 < a.indexOf("rv:11.0")) &&
            0 < $("svg").length &&
            ((i = -1),
          ...
          for (
            ...
            0 < s.indexOf(c[n]) && ((u = !0), (o = c[n].split("/").length - 2));
          1 != $("body").data("motion") ||
            (2 <= (g = location.href.split("aidn")).length &&
              ((u = !0), (o = g[1].split("/").length - 3))),
            u &&
        ...
        _isJapanese ||
                  ...
                  !document.querySelector(".goog-te-menu-frame") ||
                    (null ==
                      (e = document
                        ...
                        .contentWindow.document.querySelector("a")).onclick &&
                      (e.onclick = function (e) {
                        try {
                          document
                            .querySelector(".goog-te-banner-frame")
          ...
          0 < location.href.indexOf("/wow") &&
            ((f = `<p style="font-family: 'Sawarabi Gothic', sans-serif; font-size: calc(0.5rem + 0.6vmin); animation: none; margin-top: calc(15px + 1.5vmin);">[tx]</p>`),
            (f = _isJapanese
              ? f.replace("[tx]", "サウンドをオンにしてお楽しみください。")
              : f.replace("[tx]", "Please enjoy this content with sound on.")),
            $("#top").append(f));
        for (
          var f,
            g,
            ...
            v = "NOW ON SALE",
            w = "nyancat10th/",
            y = "daniwell/shared/img/jacket/nyancat_arrangements.png",
            b = "Nyan Cat Arrangements",
            x = "Nyan Cat Arrangements",
            c = [
              {
                path: "/nyancat/",
              },
          ...
          if (0 < s.indexOf(k.path)) {
            (u = !0),
              (_ = "_sub"),
              k.key && (_ = k.key),
              k.desc && ((p = k.desc), (v = k.desc)),
              k.descEn && (v = k.descEn),
              k.link && (w = k.link),
              k.imgPath && (y = k.imgPath),
              k.title && ((b = k.title), (x = k.title)),
        ...
        if (0 < $("#aidnx").length || u) {
          var E = 2; //(s = (0 <= (s = location.href.split("#")[0].split("?")[0]).indexOf("aidn.jp/") ? s.split("aidn.jp/") : s.split("aidn/"))[1]).split("/").length;
          0 < $("#aidnx").length && (_ = "_aidnx");
          for (var O = "", n = 0; n < E - 1; n++) O += "../";
          y.indexOf("http") < 0 && (y = O + y),
            w.indexOf("http") < 0 && (w = O + w),
            "" != O && __addRelease(y, w, b, x, p, v, m, _);
        }
        0 < $("#aidn").length && (_active = !1),
          ...
          _active ||
            ((g = aidn.constant.advUrlEn),
            (f = ""),
            (f +=
              '<a href="' +
              (g = aidn.util.checkJapanese() ? aidn.constant.advUrlJa : g) +
              '" target="_blank"><div class="adv_con">'),
            ...
            (f +=
              ...
              '" /></p>'),
            (f += "</div></a>"),
            0 < (g = $("#common_back")).length &&
              ((f =
                '<div class="adv"><div class="hr_top"></div>' + f + "</div>"),
...
(_active =
  ...
  (aidn.WebAudio = function () {
    ...
    (this.load = function (e, u, t, n) {
      ...
      var l,
        e = aidn.audio.getPath(e);
      return (
        !(!e && !i) &&
        (i
          ? c()
          : ((l = new XMLHttpRequest()).open("GET", e, !0),
      ...
      (this.play = function (e, t, n, i, a, o, r) {
        ...
        var d,
          l = [f, m];
        g && l.push(g), p && l.push(p);
        for (var c = 1; c < l.length; c++)
          (u = l[c - 1]), (d = l[c]), u.connect(d);
        for (var s, u = d, c = 0; c < E.length; c++)
          O[c] ? (u.connect(E[c]), (u = E[c])) : (d.connect(E[c]), (d = E[c]));
        if (r) {
      ...
      (this.initBiquadFilter = function (e) {
        return (
          void 0 === e && (e = 0), ((p = I.createBiquadFilter()).type = e), p
        );
      }),
  ...
  (aidn.SceneManager = function () {
    ...
    (this.init = function (e, t = 150) {
      ...
      (this.show = function (e, t = !0) {
        0 <= n &&
          (l(d[n]), clearTimeout(i), t && (i = setTimeout(l, 2 * r, d[n]))),
          0 <= e &&
            (o(d[e]), clearTimeout(a), t && (a = setTimeout(o, 2 * r, d[e]))),
          (n = e);
      });
  }),
