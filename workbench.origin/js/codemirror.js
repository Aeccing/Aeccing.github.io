      ...
      479: (t, e, i) => {
        ...
        class Pt {
          ...
          map(t, e) {
            ...
            return {
              mapped: i.length ? new Pt(n, r, i, o) : null,
              pos: s,
            };
          }
        }
        ...
        function Wn(t, e) {
          ...
          return {
            pos: i,
            bias: An(t, i, e.clientX, e.clientY),
          };
        }
        ...
        sa([
          ...
          {
            tag: wa.special(wa.variableName),
        ...
        class Ra {
          ...
          static init(t) {
            let e = Math.min(3e3, t.doc.length),
              i = Va.create(t.facet(Ua).parser, t, {
                from: 0,
                to: e,
              });
          ...
          update(t, e) {
            ...
            for (let i of e.effects)
              i.is(hl) && !dl(t, i.value.from, i.value.to)
                ? (t = t.update({
                    add: [vl.range(i.value.from, i.value.to)],
                  }))
                : i.is(cl) &&
                  (t = t.update({
        ...
        const Bc = G.define({
            ...
            update(t, e) {
              ...
              for (let i of e.effects)
                i.is(Ic)
                  ? (t = t.update({
                      add: [zc.range(i.value, i.value + 1)],
                    }))
                  : i.is(Gc) &&
                    (t = t.update({
                      filter: (t) => t != i.value,
        ...
        const Tu = Cr.baseTheme({
          ...
          ".cm-lintRange-error": {
            backgroundImage: Cu("#d11"),
          },
          ".cm-lintRange-warning": {
            backgroundImage: Cu("orange"),
          },
          ".cm-lintRange-info": {
            backgroundImage: Cu("#999"),
          },
          ".cm-lintRange-active": {
        ...
        const Zd = {
          ...
          Cd = [
            {
              tag: wa.definitionKeyword,
              class: "cm-at-rule",
            },
            {
              tag: wa.controlKeyword,
              class: "cm-at-rule",
            },
            {
              tag: wa.namespace,
            ...
            {
              tag: wa.compareOperator,
              class: "",
            },
            {
              tag: wa.logicOperator,
              class: "cm-keyword",
            },
            {
              tag: wa.arithmeticOperator,
              class: "",
            },
            {
              tag: wa.modifier,
